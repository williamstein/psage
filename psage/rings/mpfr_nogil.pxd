...
cdef extern from "mpfr.h" nogil:
    ...
    int mpfr_set (mpfr_ptr, mpfr_srcptr, mp_rnd_t) 
    ...
    int mpfr_mul_d (mpfr_ptr, mpfr_srcptr,double, mp_rnd_t)   ## This was not in original
...
#     ctypedef mp_rnd_t mpfr_rnd_t
#     void mpfr_init2 (mpfr_ptr, mp_prec_t)
#     void mpfr_init (mpfr_ptr)
#     void mpfr_clear (mpfr_ptr)
#     int mpfr_const_pi (mpfr_t, mp_rnd_t)
#     int mpfr_mul_ui (mpfr_t, mpfr_t, unsigned long int, mp_rnd_t)
...
#     int mpfr_add_ui (mpfr_ptr, mpfr_srcptr, unsigned long, mp_rnd_t)
#     void mpfr_set4 (mpfr_ptr, mpfr_srcptr, mp_rnd_t, int)
#     void mpfr_set (mpfr_ptr, mpfr_srcptr, mp_rnd_t)
#     unsigned long mpfr_get_ui (mpfr_srcptr, mp_rnd_t)
...
#     #int mpfr_const_pi (mpfr_ptr, mp_rnd_t)
#     int mpfr_pow (mpfr_ptr, mpfr_srcptr, mpfr_srcptr, mp_rnd_t)
#     int mpfr_pow_si (mpfr_ptr, mpfr_srcptr, long int, mp_rnd_t)
#     int mpfr_pow_ui (mpfr_ptr, mpfr_srcptr, unsigned long int, mp_rnd_t)
#     int mpfr_log (mpfr_ptr, mpfr_srcptr,mp_rnd_t)
#     int mpfr_set_si (mpfr_ptr, long, mp_rnd_t)
...
#     int mpfr_abs (mpfr_ptr, mpfr_srcptr, mp_rnd_t)
#     int mpfr_neg (mpfr_ptr, mpfr_srcptr, mp_rnd_t)
#     int mpfr_div_ui (mpfr_ptr, mpfr_srcptr, unsigned long, mp_rnd_t)
#     int mpfr_set_si_2exp (mpfr_ptr, long, mpfr_exp_t, mp_rnd_t)
#     void mpfr_set_prec (mpfr_ptr, mp_prec_t)
#     int mpfr_div (mpfr_ptr, mpfr_srcptr,mpfr_srcptr, mp_rnd_t)
#     int mpfr_sqrt (mpfr_ptr, mpfr_srcptr,mp_rnd_t)
#     int mpfr_erfc (mpfr_ptr, mpfr_srcptr,mp_rnd_t)
#     int mpfr_const_euler (mpfr_ptr, mp_rnd_t)
#     int mpfr_set_d(mpfr_ptr, double, mp_rnd_t)
#     int mpfr_sub_si (mpfr_ptr, mpfr_srcptr, long int, mp_rnd_t)
#     int mpfr_mul_si (mpfr_ptr, mpfr_srcptr, long int, mp_rnd_t)
#     int mpfr_zero_p (mpfr_srcptr)
#     int mpfr_div_si (mpfr_ptr, mpfr_srcptr, long int, mp_rnd_t)
#     int mpfr_mul_d (mpfr_ptr, mpfr_srcptr,double, mp_rnd_t)
#     float mpfr_get_flt (mpfr_srcptr, mp_rnd_t)
#     #int mpfr_zero_p (mpfr_srcptr)
#     int mpfr_sub (mpfr_ptr, mpfr_srcptr, mpfr_srcptr, mp_rnd_t)
#     long mpfr_get_si (mpfr_srcptr, mp_rnd_t)
...
cdef extern from "mpc.h" nogil:
    ...
    # # Projection
    # int mpc_real (mpfr_t rop, mpc_t op, mp_rnd_t rnd)
    # int mpc_imag (mpfr_t rop, mpc_t op, mp_rnd_t rnd)
    # mpfr_t mpc_realref (mpc_t op)
    # mpfr_t mpc_imagref (mpc_t op)
    # int mpc_arg (mpfr_t rop, mpc_t op, mp_rnd_t rnd)
    # int mpc_proj (mpc_t rop, mpc_t op, mpc_rnd_t rnd)
